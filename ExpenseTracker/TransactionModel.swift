...
extension Category {
    ...
    static let groceries = Category(id: 501, name: "Groveries", icon: .shopping_basket, mainCategoryId: 5)
    static let restaurants = Category(id: 502, name: "Groceries", icon: .shopping_basket, mainCategoryId: 5)
